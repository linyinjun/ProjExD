...
def main():
    ...
    scrn_sfc = pg.display.set_mode((1400, 800))
    scrn_rct = scrn_sfc.get_rect()
    pgbg_sfc = pg.image.load("/Users/linyinjun/Desktop/学校/２年/後期/演習テーマD/ProjExD2022/ProjExD/fig/pg_bg.jpg")
    pgbg_rct = pgbg_sfc.get_rect()
    scrn_sfc.blit(pgbg_sfc,pgbg_rct)

    # 練習３
    tori_sfc = pg.image.load("/Users/linyinjun/Desktop/学校/２年/後期/演習テーマD/ProjExD2022/ProjExD/fig/6.png")
    ...
    bomb_sfc = pg.transform.rotozoom(bomb_sfc, 0, 3.0)
...
if __name__ == "__main__":
    pg.init()
    main()
    tkm.showerror(tkm.showerror("負けた"))
    pg.quit()
    sys.exit()